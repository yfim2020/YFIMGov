...
contract YearnRewards {
  ...
  IERC20 constant public YFIM = IERC20(0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e);
  ...
  function claimable(address _claimer) public view returns (uint) {
      uint _amount = YFIM.balanceOf(_claimer);
      uint _adai = adai.balanceOf(address(this));
      uint _totalSupply = YFIM.totalSupply();
      uint _balance = YFIM.balanceOf(address(this));
  ...
  function claim(uint _amount) public {
      ...
      YFIM.safeTransferFrom(msg.sender, address(this), _amount);
